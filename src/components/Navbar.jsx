            ...
            <div className="ml-auto flex items-center">
              <div className="flex items-center gap-5 px-9 py-3" style={{ background: "#6c5ce7" }}>
                {["M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"].map((path, index) => (
                  <a key={index} href="#" className="text-white opacity-80 transition-opacity hover:opacity-100">
        ...
        <div className="border-t border-white/10 bg-[#151528] lg:hidden">
          <div className="mx-auto max-w-7xl px-4 py-4">
                ...
                link.name === "Services" ? (
                  <div key={link.name}>
                    ...
                    >
                      ...
                      <svg className={`h-4 w-4 transition-transform ${isServicesDropdownOpen ? "rotate-180" : ""}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                        <path d="M6 9l6 6 6-6" />
                      </svg>
                    </button>
                    {isServicesDropdownOpen && (
                      <div className="ml-3 border-l border-white/10 pl-3">
                        <Link
                          ...
                          className="block rounded-lg px-3 py-2 text-sm text-[#bbb] hover:bg-white/5 hover:text-white"
                        >
                          All Services
                        </Link>
                        {servicesLinks.map((service) => (
            ...
            <Link
              to="/contact"
              onClick={closeMobileMenu}
              className="mt-4 block rounded-lg bg-[#6c5ce7] px-4 py-3 text-center font-semibold text-white"
            >
              Contact Us
            </Link>
          </div>
